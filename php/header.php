        ...
        <ul class="navbar-nav mr-auto">
            <?PHP
                if (isset($_SESSION['adminRights'])) {
                    if($_SESSION['adminRights'] == 2) { // Only admins can see these sites
                    ...
                    } else if($_SESSION['adminRights'] == 3) { // Normal users will see this
                        echo "<li class='nav-item'>
        ...
        <ul class="nav navbar-nav navbar-right">
            <?php
                if (isset($_SESSION['email'])) { // Shows the Profile Dropdown for the current user
                    ...
                    <a role='button' href='profil.php' class='btn btn-primary'>" . $_SESSION['firstName'] . "</a>
